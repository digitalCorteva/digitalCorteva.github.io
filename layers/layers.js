...
var format_SiembraVariable_4 = new ol.format.GeoJSON();
var features_SiembraVariable_4 = format_SiembraVariable_4.readFeatures(json_SiembraVariable_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SiembraVariable_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SiembraVariable_4.addFeatures(features_SiembraVariable_4);
var lyr_SiembraVariable_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SiembraVariable_4, 
                style: style_SiembraVariable_4,
                interactive: true,
    title: 'Siembra Variable<br />\
    <img src="styles/legend/SiembraVariable_4_0.png" /> 100000<br />\
    <img src="styles/legend/SiembraVariable_4_1.png" /> 110000<br />\
    <img src="styles/legend/SiembraVariable_4_2.png" /> 115000<br />'
        });

lyr_GoogleHybrid_0.setVisible(true);lyr_Rendimientotha_1.setVisible(true);lyr_ZonaOptimizado_2.setVisible(true);lyr_ZonaConvencional_3.setVisible(true);lyr_SiembraVariable_4.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_Rendimientotha_1,lyr_ZonaOptimizado_2,lyr_ZonaConvencional_3,lyr_SiembraVariable_4];
...
lyr_SiembraVariable_4.set('fieldAliases', {'DN': 'DN', 'seeds': 'seeds', });
...
lyr_SiembraVariable_4.set('fieldImages', {'DN': 'TextEdit', 'seeds': 'TextEdit', });
lyr_Rendimientotha_1.set('fieldLabels', {'id': 'no label', 'left': 'no label', 'top': 'no label', 'right': 'no label', 'bottom': 'no label', 'VALUE': 'no label', 'CLASE_n': 'no label', 'RENDIMIENT': 'no label', 'CON_05': 'no label', 'CON_1': 'no label', 'CLASE': 'no label', });
lyr_ZonaOptimizado_2.set('fieldLabels', {'Field': 'no label', 'Dataset': 'no label', 'Product': 'no label', 'Obj__Id': 'no label', 'Swth_Wdth_': 'no label', 'Distance_m': 'no label', 'Duration_s': 'no label', 'Track_deg_': 'no label', 'Elevation_': 'no label', 'Area_Count': 'no label', 'Time': 'no label', 'Y_Offset_m': 'no label', 'Pass_Num': 'no label', 'Moisture__': 'no label', 'Crop_Flw_M': 'no label', 'Speed_km_h': 'no label', 'Crop_Flw_V': 'no label', 'Yld_Mass_W': 'no label', 'Yld_Mass_D': 'inline label', 'Yld_Vol_We': 'no label', 'Yld_Vol_Dr': 'no label', 'Prod_ha_h_': 'no label', 'Date': 'no label', });
...
lyr_SiembraVariable_4.set('fieldLabels', {'DN': 'no label', 'seeds': 'header label', });
lyr_SiembraVariable_4.on('precompose', function(evt) {
